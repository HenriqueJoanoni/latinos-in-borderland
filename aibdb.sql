...
/* >>>>FAE EDITING<<<< */
    ...
    (6, NULL,
     ...
     'Ten of Clubs', 'HIGH DIFFICULTY', 10, '2'),
    (7, NULL,
     'Players need to cooperate to defeat all the beasts in the venue',
     'Six of Spades', 'MEDIUM DIFFICULTY', 4, '4'),
    (8, NULL,
    ...
    (10, GAMEMASTER,
     ...
     'Jack of Hearts', 'HIGH DIFFICULTY', 20, '3'),
    (11, 3,
     ...
     'Queen of Spades', 'HIGH DIFFICULTY', 20, '4'),
    (12, GAMEMASTER,
     ...
     'King of Diamonds', 'HIGH DIFFICULTY', 5, '1'),
    (13, 5,
     ...
     'Queen of Clubs', 'HIGH DIFFICULTY', 14, '11'),
    (14, GAMEMASTER,
     ...
     'King of Spades', 'HIGH DIFFICULTY', 253, 'N/A'),
    (15, GAMEMASTER,
     ...
     'Queen of Hearts', 'HIGH DIFFICULTY', 3, '2');
...
INSERT INTO player_status (status_id, injury, death, player_id) /* EDITING TO TABLE */
VALUES
/* >>>>FAE EDITING<<<< */
    (1, 1, 1, 14),
...
INSERT INTO death_log (death_log_id, death_reason, player_id)
VALUES
/* >>>>FAE EDITING<<<< */
    (1, 'Killed by Explosive Collar', 20),
    (2, 'Killed by Aguni Morizono', 25),
    (3, 'Killed by Laser', 14),
    (4, 'Killed by Fire', 24),
    (5, 'Killed by Explosive Collar after guessing her suit incorrectly', 26),
    (6, 'Killed by Laser', 17);

INSERT INTO injury_log (injury_id, injury_type, severity, player_id)
VALUES
/* >>>>FAE EDITING<<<< */
    (1, 'Knocked Unconscious', 'LOW SEVERITY', 18),
    (2, 'Beaten Up', 'MEDIUM SEVERITY', 15),
    (4, 'Severe Burns on Face and Body', 'HIGH SEVERITY', 22),
    (3, 'Gunshot Wound', 'HIGH SEVERITY', 21), /*THE INJURY IS NOT IN A GAME - DID NOT RECORD IN PLAYER_STATUS TABLE*/
    (5, 'Gunshot Wound', 'HIGH SEVERITY', 22); /*THE INJURY IS NOT IN A GAME - DID NOT RECORD IN PLAYER_STATUS TABLE*/